...
exports.answers = function (req, res) {
    return statistics(req, res, mdb.Answers);
};

exports.successes = function (req, res) {
    return statistics(req, res, mdb.Successes);
};
